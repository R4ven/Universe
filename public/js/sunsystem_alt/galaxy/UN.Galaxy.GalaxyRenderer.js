...
var init = function() {
	...
	gradientImage.src = TEXTUREPATH + 'star_color_modified.png';	
}
...
var postShadersLoaded = function(){
	$.loadJSonData( "galaxy/json/"+GalaxyID , function(loadedData){
...
var animate = function() {
	...
	UN.Galaxy.shaderTiming = (Date.now() - startTime )/ 1000;
