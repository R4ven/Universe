...
UN.SunSystem.Planet = function(params) {
	...
	this.system.update = function() {
		...
		if(typeof self.planetMesh == "object") {
...
UN.SunSystem.Planet.prototype = Object.create( UN.SpaceObject.prototype );

UN.SunSystem.Planet.prototype.getJSON = function() {
	var obj = {
		uid : this.uid,
		name : this.name,
		coord : this.coord,
...
UN.SunSystem.Planet.prototype.init = function(params) {
...
UN.SunSystem.Planet.prototype.getMaterial = function( type ) {
	var map = null;
	switch(type) {
...
UN.SunSystem.Planet.prototype.getSystem = function() {
	return this.system;
}

UN.SunSystem.Planet.prototype.getPlanetBase = function() {
	var self = this;
...
UN.SunSystem.Planet.prototype.getPlanetLine = function() {
	var self = this;
	var position = this.position;
...
UN.SunSystem.Planet.prototype.getSpaceRadius = function() {
	var color = 0xffffff;
